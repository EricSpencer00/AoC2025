...
# Start position
position = 50
# Count how many times the dial passed 0 during and after any rotation
zero_count = 0
...
for line in d1_input_text.strip().splitlines():
    ...
    # Simulate each individual click during the rotation. Each click
    # moves the dial one number and we count each time it lands on 0.
